...
public class TinyDB {
    ...
    public ArrayList<MeasurementData> getListMeasurementData(String key) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<MeasurementData> dataList =  new ArrayList<MeasurementData>();

        for(String jObjString : objStrings){
            MeasurementData data  = gson.fromJson(jObjString,  MeasurementData.class);
            dataList.add(data);
        }
        return dataList;
    ...
    /** Put MeasurementData Object into SharedPreferences with 'key' and save */

    public void putListMeasurementData(String key, ArrayList<MeasurementData> dataList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
